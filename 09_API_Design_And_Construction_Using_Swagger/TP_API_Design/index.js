...
let mahasiswa = [
  { nama: "Benedictus Qosta Noventino Baru", nim: "2311104029" },
  { nama: "Muhammad Rifqi Al Baqi Ananta", nim: "2311104005" },
  { nama: "Ahmad Uffi Lestari Ma’ruf ", nim: "2311104015" },
...
app.get("/", (req, res) => {
  res.send(
    "Selamat datang di API Mahasiswa! Gunakan endpoint /api/mahasiswa untuk melihat data."
  );
});
